...
class AppTextStyle{
  ...
  static TextStyle header1({BuildContext context, Color color, double size, FontWeight fontWeight}) {
  ...
  static TextStyle header2({BuildContext context, Color color, double size, FontWeight fontWeight}) {
